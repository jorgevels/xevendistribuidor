...
import shoesBanner from "../../assets/images/Banner-Juguetes.png";
import "./Toy.scss";
...
const BarbershopPage = () => {
  ...
  const BarbershopProducts = products.filter(
    (product) => product.title === "Juguete"
  );
    ...
    <>
      ...
      <section className="py-5 no-pt">
        <div className="container">
          <Title title="LOS MEJORES JUGUETES PARA COMPARTIR EN PAREJA" />
          <div className="row">
            {BarbershopProducts.map((product) => {
              return (
                <div
                  key={product.id}
