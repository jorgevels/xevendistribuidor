...
import shirtBanner from "../../assets/images/Banner-Lubricantes.png";
...
const TreatmentPage = () => {
  ...
  const treatmentProducts = products.filter(
    (product) => product.title === "Lubricante"
  );
    ...
    <>
      ...
      <section className="py-5 no-pt">
        <div className="container">
          <Title title="LOS MEJORES LUBRICANTES" />
          <div className="row">
