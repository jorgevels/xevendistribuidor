...
import shoesBanner from "../../assets/images/Banner-Electrizantes.png";
import "./Electrifying.scss";
...
const FacialCare = () => {
  ...
  const FacialCareProducts = products.filter(
    (product) => product.title === "Electrizante"
  );
    ...
    <>
      ...
      <section className="py-5 no-pt">
        <div className="container">
          <Title title="LOS MEJORES LUBRICANTES ELECTRIZANTES" />
          <div className="row">
