...
import shoesBanner from "../../assets/images/Banner-Pheromonas.png";
import "./Pheromonas.scss";
...
const CosmeticsPage = () => {
  ...
  const CosmeticsProducts = products.filter(
    (product) => product.title === "Pheromonas"
  );
    ...
    <>
      ...
      <section className="py-5 no-pt">
        <div className="container">
          <Title title="LOS MEJORES PRODUCTOS CON PHEROMONAS A TU ALCANCE" />
          <div className="row">
